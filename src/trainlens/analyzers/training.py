...
from trainlens.heuristics import detect_class_imbalance, detect_convergence, detect_overfitting, detect_validation_instability
        ...
        if "Possible overfitting" in titles:
            recommendations.append(
                Recommendation(
                    ...
                    rationale="The validation gap suggests the model may be memorizing training examples.",
                    confidence=0.78,
                )
            )
        ...
        if not recommendations:
            recommendations.append(
                Recommendation(
                    ...
                    rationale="Inspecting false positives and false negatives usually reveals the next useful experiment.",
                    confidence=0.52,
                )
            )
